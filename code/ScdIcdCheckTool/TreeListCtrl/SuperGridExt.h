...
/////////////////////////////////////////////////////////////////////////////
// CSuperGridExt window


class CSuperGridExt : public CSuperGridCtrl
{
// Construction
public:
	CSuperGridExt();
...
public:
	...
	// Overrides
	void OnControlLButtonDown(CPoint point, LVHITTESTINFO& ht);	
	...
	//{{AFX_VIRTUAL(CSuperGridExt)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CSuperGridExt();
