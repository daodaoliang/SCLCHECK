...
public:
	// Overrides
	//MUST override this to make a copy of CItemInfo..see the CSuperGridExt.cpp for implementation
	...
	virtual void OnControlLButtonDown(CPoint point, LVHITTESTINFO& ht);
...
public:
	...
	//set bUpdate to TRUE.(see the use of bUpdate in the HowToInsertItemsAfterTheGridHasBeenInitialized function in the CSuperGridExtCtrl)
