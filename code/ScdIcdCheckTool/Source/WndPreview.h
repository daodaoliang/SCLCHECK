...
protected:
	...
	// 添加图片页面函数
	int		AddButton( LPCTSTR szName, LPCTSTR szEnName, UINT nIcon, UINT nBack );
	// 获取指定切换按钮所在位置
...
public:
	...
	void OnBnClickedBtnICDCheck();
	void OnBnClickedBtnSCDCheck();
	void OnBnClickedBtnSCDCmp();
	void OnBnClickedBtnCRCCheck();
